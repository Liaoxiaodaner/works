<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:81:"C:\wamp64\www\supermall2\public/../application/index\view\templates\depotout.html";i:1543339383;s:21:"../public/header.html";i:1543332066;}*/ ?>
<!doctype html>
<html>
<head>
<meta charset="utf-8">
        ...
        <div class="panel-body">
            ...
            <?php if(is_array($list) || $list instanceof \think\Collection): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$product): $mod = ($i % 2 );++$i;?>
                <tr>
                    ...
                    <td>
                        <a href="<?php echo url('chuku',['id'=>$product['id']]); ?>" >出库</a>
