<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:80:"C:\wamp64\www\supermall2\public/../application/index\view\templates\depotin.html";i:1543339385;s:21:"../public/header.html";i:1543332066;}*/ ?>
<!doctype html>
<html>
<head>
<meta charset="utf-8">
        ...
        <div class="panel-body">
			...
			<?php if(is_array($list) || $list instanceof \think\Collection): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$product): $mod = ($i % 2 );++$i;?>
                <tr>
                    ...
                    <td>
                        <a href="<?php echo url('ruku',['id'=>$product['id']]); ?>" >入库</a>
